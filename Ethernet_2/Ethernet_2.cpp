...
// Ethernet_2.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CEthernet2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CEthernet2App

CEthernet2App::CEthernet2App()
{
...
// Único objeto CEthernet2App

CEthernet2App theApp;


// Inicialización de CEthernet2App

BOOL CEthernet2App::InitInstance()
{
